...
class TextGenerationResponse {
  late TextGenerationResult? result; // Result object
...
// Function to create a response object from JSON data
  TextGenerationResponse.fromJson(Map<String, dynamic> json) {
    result = TextGenerationResult.fromJson(json['result']); // Create a result object from the JSON data
...
class TextGenerationResult {
  String? response; // Generated text

  TextGenerationResult({this.response}); // Constructor
// Function to create a result object from JSON data
  TextGenerationResult.fromJson(Map<String, dynamic> json) {
    response = json['response']; // Set the generated text
  }
// Function to convert the result object to JSON data
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{}; // Create a map to store the data
    data['response'] = response; // Add the generated text to the map
    return data; // Return the map
  }
}
