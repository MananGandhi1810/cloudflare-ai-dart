...
class TextClassificationModel {
  ...
  late TextClassificationModels model; // Model to use
...
// Constructor
  TextClassificationModel({
    ...
    this.model = TextClassificationModels.DISTILBERT_SST_2_INT8, // Since there is only one model we set it to the default model, no need specify it
    this.raw = true,
  }) {
